      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-4 order-lg-1">
          ...
          <h1 class="mb-4" data-aos="fade-up">
            This is a smooth website for Propertybook.com
          </h1>
          ...
          <p data-aos="fade-up">
            At Property Book, we believe in more than just selling properties;
             we specialize in creating homes and fulfilling dreams. 
             With a dedicated team of experienced real estate professionals, 
             we are committed to providing personalized service and expert guidance throughout your buying or selling journey.
          </p>
      ...
      <div class="row">
        <div class="col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="100">
            <a href="blog-details.html" class="thumb d-block">
                <img src="{{ asset('assets/img/img_h_4.jpg') }}" alt="Image" class="img-fluid rounded">
            </a>            
        ...
        <div class="col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="200">
            <a href="blog-details.html" class="thumb d-block">
                <img src="{{ asset('assets/img/img_h_2.jpg') }}" alt="Image" class="img-fluid rounded">
            </a>            
            <div class="post-content">
              <div class="meta">
                <a href="blog-details.html" class="cat">Development</a> •
        ...
        <div class="col-sm-6 col-md-6 mb-4 mb-lg-0 col-lg-4">
          <div class="post-entry" data-aos="fade-up" data-aos-delay="300">
            <a href="blog-details.html" class="thumb d-block">
                <img src="{{ asset('assets/img/img_h_3.jpg') }}" alt="Image" class="img-fluid rounded">
            </a>
